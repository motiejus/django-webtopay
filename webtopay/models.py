...
class WebToPayCallback(models.Model):
    ...
    lang = models.CharField(max_length=3, editable=False,
    ...
    payment = models.CharField(max_length=20, editable=False,
    ...
    surename = models.CharField(max_length=255, blank=True, editable=False,
    ...
    error = models.CharField(max_length=20, editable=False,
    ...
    p_email = models.TextField(editable=False,
            help_text="Pirkėjo el. paštas privalomas. Jeigu adresas nebus "+\
                    ...
                    " būklę")
    requestid = models.CharField(max_length=40, editable=False,
    ...
    paycurrency = models.CharField(max_length=10, editable=False,
    ...
    version = models.CharField(max_length=9, editable=False,
