...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WebToPayResponse.status'
        db.add_column('webtopay_webtopayresponse', 'status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=255), keep_default=False)
